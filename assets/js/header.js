...
function resetModal() {
    ...
    // Reset register form
    $("#register-name, #register-email, #register-phone, #register-password, #register-confirm-password").each(function () {
        $(this).removeClass('is-invalid');
        $(this).val('');
    });
...
$(function () {
    ...
    $("#register-name, #register-email, #register-phone, #register-password, #register-confirm-password").on('change', function () {
        $(this).removeClass('is-invalid');
    });
    ...
    myModal.addEventListener('hidden.bs.modal', function () {
        resetModal();
        // Mostrar pestaña de login al cerrar
